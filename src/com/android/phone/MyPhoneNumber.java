...
public class MyPhoneNumber extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        SharedPreferences prefs = context.getSharedPreferences(
                MyPhoneNumber.class.getPackage().getName() + "_preferences", Context.MODE_PRIVATE);
        ...
        if (mTelephonyMgr.SIM_STATE_READY != simState) {
             ...
             */
            if (DBG)
                Log.d(LOG_TAG, "simState not correct. No modification to phone number. simState: "
                        + simState);
